; ModuleID = 'examples/Bubblesort.ll'
source_filename = "Stanford/Bubblesort.c"
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @Bubble(i32 %run) #0 {
entry:
  call void @bInitarr()
...
while.end18:                                      ; preds = %while.cond
  %7 = load i32, i32* getelementptr inbounds ([5001 x i32], [5001 x i32]* @sortlist, i64 0, i64 1), align 4
  %8 = load i32, i32* @littlest, align 4
  %cmp19 = icmp ne i32 %7, %8
  br i1 %cmp19, label %if.then21, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %while.end18
  %9 = load i32, i32* getelementptr inbounds ([5001 x i32], [5001 x i32]* @sortlist, i64 0, i64 500), align 16
  %10 = load i32, i32* @biggest, align 4
...
if.end22:                                         ; preds = %if.then21, %lor.lhs.false
  ...
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %11)
  ret void
}
